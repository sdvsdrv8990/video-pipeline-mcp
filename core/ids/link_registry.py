...
# Единственный источник ORPHAN-политики: кого уведомлять о недостающем родителе.
# Конкурент группируется по нашему каналу (§4) — без канала его не найти, остальные адресуемы.
