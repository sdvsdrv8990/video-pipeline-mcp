...
# Fallback prompt-injection паттерны (если firewall.yaml без patterns).
# Только полные фразы (word-boundary); без command-injection — нет shell/SQL/Windows-поверхности.
DEFAULT_PATTERNS = [
