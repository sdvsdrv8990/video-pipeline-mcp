...
существу — объявление сценариев, роды улик, спектр заданий и вычисление тронутого вне зоны. Две
копии этого кода разъехались бы на первой правке, а разъехавшаяся половина работает наполовину.
"""
import fnmatch
import subprocess
import sys
