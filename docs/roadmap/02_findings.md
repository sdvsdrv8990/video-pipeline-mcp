...
| F22 | 🟠 | Спек-файлы дизайна (7 `*.schema.md`, `ИНСТРУКЦИЯ_*`, `Бриф`, `project_memory.spec`) лежат **вне репо** (`/home/admin/projects/`) — не версионируются, риск потери канона намерения | `ls /home/admin/projects/*.md` | OQ4 |
