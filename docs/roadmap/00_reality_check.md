...
| CI | **8 джоб**: `lint` · `studio` · `studio-app` · `test` · `conformance` · `security` · `comment-guard` · `gitleaks` | `python3 -c "import yaml;print(list(yaml.safe_load(open('.github/workflows/ci.yml'))['jobs']))"` |
...
| Нет `.github/workflows/` | ✅ закрыто (I3): CI, сегодня 8 джоб — состав в §1 |
