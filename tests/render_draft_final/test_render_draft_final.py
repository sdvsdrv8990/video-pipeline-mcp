"""
tests/render_draft_final/test_render_draft_final.py — сквозной прогон рендера draft → final.

## Назначение
Основной рабочий кейс через настоящие инструменты сервера: структура проекта, черновик,
финал со ссылкой на черновик, чтение результата через `fs_read_file`.
Пишет в рабочую область — файлы создаются настоящие.
"""
